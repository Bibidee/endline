...
The deployed frontend is https://the-edl.vercel.app. It is built against Studionet and the verified contract, and public unauthenticated access to the production alias has been verified.
