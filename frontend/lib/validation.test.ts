...
describe('source boundary matrix',()=>{
  ...
  const rejected=['ftp://example.com','javascript:alert(1)','https://127.0.0.1','https://0.0.0.0','https://192.168.1.1','https://10.0.0.1','https://172.16.0.1','https://169.254.1.1','https://[::1]','https://user@example.com','https://user:pass@example.com','https://x.local','not a url','https://'];
